/**
 * Vercel Serverless API Handler - OAuth Routes
 * Handles authorization, token exchange, and callback flows
 */

import crypto from 'crypto';
import { decodeJwt } from 'jose';
import { validateBasicOAuthConfig } from '../src/config.js';
import * as store from '../src/state/sessionStore-serverless.js';
import * as logger from '../src/services/logger-serverless.js';
